    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${pageContext.request.contextPath}/meals?id=${meal.id}"><spring:message code="common.update"/></a></td>
                <td><a href="${pageContext.request.contextPath}/meals?id=${meal.id}"><spring:message code="common.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
